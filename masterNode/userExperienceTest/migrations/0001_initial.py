    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('script_path_ie', models.CharField(max_length=200, verbose_name='ie\u7684\u517c\u5bb9\u6027\u6d4b\u8bd5\u811a\u672c\u7684\u8def\u5f84')),
                ('script_path_firefox', models.CharField(max_length=200, verbose_name='firefox\u7684\u517c\u5bb9\u6027\u6d4b\u8bd5\u811a\u672c\u7684\u8def\u5f84')),
                ('script_path_chrome', models.CharField(max_length=200, verbose_name='chrome\u7684\u517c\u5bb9\u6027\u6d4b\u8bd5\u811a\u672c\u7684\u8def\u5f84')),
            ],
        ),
        migrations.CreateModel(
            name='ImageReport',
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('test_id', models.CharField(max_length=20, verbose_name='\u517c\u5bb9\u6027\u6d4b\u8bd5\u7f16\u53f7')),
                ('browser', models.CharField(max_length=100, verbose_name='\u6d4f\u89c8\u5668')),
                ('name', models.CharField(max_length=200, verbose_name='\u622a\u56fe\u540d\u79f0')),
                ('correct_image_path', models.CharField(max_length=200, verbose_name='\u6b63\u5e38\u7684\u622a\u56fe\u6240\u5728\u8def\u5f84')),
                ('real_image_path', models.CharField(max_length=200, verbose_name='\u5b9e\u9645\u7684\u622a\u56fe\u6240\u5728\u8def\u5f84')),
                ('image_status', models.BooleanField(verbose_name='\u622a\u56fe\u662f\u5426\u6b63\u5e38')),
            ],
        ),
        migrations.CreateModel(
            name='Plan',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_path', models.CharField(max_length=100, verbose_name='\u62a5\u544a')),
                ('apdex', models.FloatField(verbose_name='Apdex')),
                ('browser', models.CharField(max_length=100, verbose_name='\u6d4f\u89c8\u5668')),
                ('display_status', models.BooleanField(verbose_name='\u754c\u9762\u663e\u793a\u662f\u5426\u6b63\u5e38')),
            ],
        ),
        migrations.CreateModel(
            name='System',
