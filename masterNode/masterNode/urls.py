...
urlpatterns = [
    ...
    url(r'^imageresult/(?P<test_id>\d+)/$', views.image_result, name='imageresult'),
    ...
    url(r'^adduserexperiencetest/', views.add_user_experience_test),
    url(r'^createuserexperiencetestscript/', views.create_user_experience_test_script),
    url(r'^createuserexperiencetestscriptsuccess/', views.create_user_experience_test_script_success),
    url(r'^createuserexperiencetesttask/', views.create_user_experience_test_task),
    url(r'^userexperiencetest/', views.user_experience_test),
